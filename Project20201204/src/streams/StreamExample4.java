...
public class StreamExample4 {
	public static void main(String[] args) {
		...
		list.stream().filter((s) -> s.getSalary() > 0

		).sorted().forEach(new Consumer<EmployeeVO>() {
		...
		System.out.println("[ firstName을 기준으로 출력 ]");
		
		list.stream().sorted().forEach(new Consumer<EmployeeVO>() {
